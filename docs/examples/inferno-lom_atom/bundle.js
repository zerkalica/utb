  ...
  function scuMobx(nextProps, nextState) {
    ...
    for (var i = keys.length - 1; i >= 0; i--) {
      ...
      if (newValue !== this$1.props[key]) {
        return true;
      } else if (newValue && _typeof$1(newValue) === "object" && !mobx.isObservable(newValue)) {
...
ErrorableView._r = [1];
var lomCreateElement = createCreateElement(createReactWrapper(infernoCompat_3, ErrorableView), infernoCompat_2);
