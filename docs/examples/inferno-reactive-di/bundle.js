...
var infernoCompat_3 = infernoCompat$1.Component;
...
function extendObservableHelper(target, defaultEnhancer, properties) {
  ...
  invariant(_typeof$2(target) === "object", getMessage("m015"));
  invariant(!isObservableMap(target), getMessage("m016"));
  properties.forEach(function (propSet) {
    invariant(_typeof$2(propSet) === "object", getMessage("m017"));
...
var dist$3 = createCommonjsModule(function (module, exports) {
  ...
  var createClass = _interopDefault(infernoCreateClass);
  ...
  function scuMobx(nextProps, nextState) {
    ...
    for (var i = keys.length - 1; i >= 0; i--) {
      ...
      if (newValue !== this$1.props[key]) {
        return true;
      } else if (newValue && _typeof$2(newValue) === "object" && !mobx.isObservable(newValue)) {
...
var infernoMobx = createCommonjsModule(function (module) {
...
ErrorableView._r = [1];
var atomize = createReactWrapper(infernoCompat_3, ErrorableView, new Injector([[AbstractLocationStore, new BrowserLocationStore(location, history)]]));

var lomCreateElement = createCreateElement(atomize, infernoCompat_2);
...
var TodoFilterService = (_class$1 = (_temp = _class2$2 =
/*#__PURE__*/
function () {
...
infernoCompat_1(lom_h(TodoPerfView, null), document.getElementById('todoapp'));
